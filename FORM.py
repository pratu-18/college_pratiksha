...
if selected == "Addmission":
    form:st=st.form("Bsic")
form.title("fill the form")
name = form.text_input("Enter your name: ")
address = form.text_area("Enter your address:")
std = form.selectbox("Enter your class to get addmission",
                           ("FYBCA", "FYBSC-IT", "SYBCA", "SYBSC-IT", "TYBCS", "TYBSC-IT"))
email =form.text_input("Enter Mail:")


age = form.slider("Enter your age", min_value=18, max_value=100, step=2)

date =form.date_input("Enter your birth", value=datetime.date(2023, 4, 13))  # 2023 , 4 , 13 default value
